        ...
        <div className="p-4">
            ...
            <DataTable value={products} responsiveLayout="scroll">
                ...
                <Column field="image_url" header="Image" body={(rowData) => (
                    rowData.image_url ? <img src={rowData.image_url} alt={rowData.product_name} width="50" /> : 'No Image'
                )}></Column>
            ...
            <Dialog visible={productDialog} style={{ width: '450px' }} header="Product Details" modal className="p-fluid" footer={
                ...
                <div className="p-field">
                    ...
                    <Dropdown id="category_id" value={product.category_id} options={categories} onChange={(e) => setProduct({ ...product, category_id: e.value })} optionLabel="category_name" placeholder="Select a Category" optionValue="category_id"/>
                </div>
                <div className="p-field">
