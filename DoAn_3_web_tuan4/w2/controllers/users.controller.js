    ...
    users.getByUsernamePass(username, password, (result) => {
      if (result) {
        ...
        const token = jwt.sign(
          { user_id: result.user_id, fullname: result.fullname, username: result.username, email: result.email, phone_number: result.phone_number, address: result.address, image_user: result.image_user },
          SECRET_KEY,
